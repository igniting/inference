# Appendix D2. Decision Checklists for Practitioners
...
interconnect). TP stays within each node. See Ch. 13 for EP/TP interaction.

**Reference:** Ch. 12, Ch. 10, Ch. 13
...
| Checklist                          | Chapters        |
|------------------------------------|-----------------|
| 1. Parallelism configuration       | Ch. 12, 10, 13  |
| 2. KV cache sizing                 | Ch. 7           |
| 3. Chunked prefill                 | Ch. 6           |
| 4. Prefix caching                  | Ch. 7, 15       |
| 5. Disaggregate prefill and decode | Ch. 14          |
| 6. Quantization selection          | Ch. 10          |
| 7. Speculative decoding            | Ch. 11          |
| 8. Routing policy                  | Ch. 16          |
| 9. Autoscaling                     | Ch. 16, 23      |
| 10. Deployment health              | Ch. 16, 23      |
